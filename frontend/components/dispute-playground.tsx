      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            >
              {isSelected ? <Check className="size-4" /> : <FileText className="size-4" />}
            </span>
            ...
            <span className="shrink-0 text-xs font-semibold text-primary">Attached</span>
          </div>
        )
      })}
    </div>
...
export function DisputePlayground() {
  ...
  const events = useMemo(() => {
    ...
    if (merchantSubmitted) {
      ...
      next[3] = { label: 'AI investigation', detail: '5-layer graph & deterministic checks verified', status: 'complete' }
      next[4] = { label: 'Decision ready', detail: 'Explainable verdict synthesized', status: 'complete' }
    }
    return next
  }, [customerSubmitted, merchantSubmitted, scenario])
              ...
              <div className="mt-4 flex flex-col gap-4">
                ...
                <div>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <span className="text-[11px] text-muted-foreground">{scenario.customerEvidence.length} files attached</span>
                  </div>
                  <EvidenceList
                  ...
                  <>
                    ...
                    <div>
                      <div className="mb-2 flex items-center justify-between">
                        ...
                        <span className="text-[11px] text-muted-foreground">{scenario.merchantEvidence.length} files attached</span>
                      </div>
                      <EvidenceList
              ...
              <div>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="rounded-md bg-blue-100 px-2 py-0.5 text-[10px] font-semibold text-blue-800 dark:bg-blue-950 dark:text-blue-300">
                    ⚡ 3 Days Resolution (42 Days Saved vs 45d Industry SLA)
                  </span>
                </div>
